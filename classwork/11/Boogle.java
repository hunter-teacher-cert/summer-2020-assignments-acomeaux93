...
public class Boogle
{
  ...
  public static int getSmallest(ArrayList<Integer> al, int l, int h) {
    int smol = al.get(0);
    int idx = 0;
  ...
  public void selectSort (ArrayList<Integer> al) {
    int temp = 0;
    int l = 0;
    int h = al.size();

    while (l < h -1) {
      int idx = getSmallest(al, l, h);
  ...
  public static void main( String[] args ) {
    ...
    int smol;
    System.out.println("Find smol");
    ArrayList<Integer> smolist = prestoArrayListo(25,0,1993);
    smol = getSmallest(smolist, 0, smolist.size());
    System.out.println(smolist);
